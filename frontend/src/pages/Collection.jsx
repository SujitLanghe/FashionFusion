    ...
    <div className='flex flex-col sm:flex-row gap-1 sm:gap-10 pt-10 border-t'>
      ...
      <div className='min-w-60'>
        ...
        <p
          ...
          className='my-2 text-xl flex items-center sm:cursor-pointer gap-2'
        >
          FILTERS
          <img
        ...
        {/* Filter Section - Always visible on laptop screens, toggleable on small screens */}
        ...
        {/* SubCategory Filter - Always visible on laptop screens, toggleable on small screens */}
